...
const projects = [
  ...
  },
  {
    ...
    tech: [ "React.js",
      ...
      "TailwindCSS",
      "HTML",],
    keyFeatures: ["Roommate search", "Profile management", "all users data are stored in Database"],
    challenges: "Matching algorithms.",
    solution: "Used location and preference filters.",
    futurePlan: "Add AI-based roommate suggestions, Payment Management, Google Map Integration etc",
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-16 px-4 bg-gray-50 dark:bg-gray-900">
      ...
      <div className="mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-24">
